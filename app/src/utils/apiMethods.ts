import { z } from "zod"
import { requestJson, type RequestParams } from "./apiClient"

export const postJson = <T extends z.ZodTypeAny>(
  params: Omit<RequestParams<T>, "method" | "contentType">,
) => {
  return requestJson({ ...params, method: "POST", contentType: "application/ld+json" })
}

export const fetchJson = <T extends z.ZodTypeAny>(params: Omit<RequestParams<T>, "method">) => {
