...
import { z } from 'zod';
import { f as useRoute, a as useRouter, g as useNuxtApp, m as GroupSchema, U as UserSchema, o as dateSchema, p as UserDTOSchema, q as CategorySchema, D as DateSchema } from './server.mjs';
import { b as getCurrentMonthStartDate, f as formatDateISO } from './date-Bb1fHl5x.mjs';
...
const useExpenseMutation = () => {
  ...
  const createExpenseMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      router.push({ name: "group", params: { group_id } });
    }
  });
...
//# sourceMappingURL=useExpenseMutation-j9BSAjg5.mjs.map
