...
import { u as useRouter, a as script$2, s as script } from './server.mjs';
import script$1 from './index-C6svMn5Y.mjs';
import script$3 from './index-BFyCJmjE.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(testimonials, (testimonial, index) => {
        _push(ssrRenderComponent(unref(script), { key: index }, {
...
//# sourceMappingURL=index-CvFV31Bi.mjs.map
