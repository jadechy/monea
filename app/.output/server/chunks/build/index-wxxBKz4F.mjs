...
import { defineComponent, resolveComponent, withCtx, createTextVNode, createVNode, unref, ref, mergeProps, toDisplayString, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="flex justify-between px-10 items-center mt-2"><h1 class="font-extrabold text-center text-4xl">Mon\xE9a</h1><div class="flex gap-4 items-center">`);
      _push(ssrRenderComponent(_component_RouterLink, { to: { name: "index" } }, {
      ...
      _push(ssrRenderComponent(_component_RouterLink, { to: { name: "auth-login" } }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Button, { size: "small" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Commencer \xE0 gerer le budgets`);
                } else {
                  return [
                    createTextVNode("Commencer \xE0 gerer le budgets")
                  ];
                }
              }),
              _: 1
      ...
      _push(`</div></div><main class="p-10"><section class="flex gap-10 items-center"><div class="flex flex-col gap-6"><p class="text-6xl font-extrabold">Mon\xE9a</p><p class="text-2xl font-light text-gray-700"> G\xE9rez vos budgets en toute simplicit\xE9. </p><p> Une application intuitive pour suivre vos d\xE9penses, planifier l\u2019avenir et garder le contr\xF4le de vos finances personnelles ou en groupe. </p><div class="flex gap-3">`);
      ...
      _push(`</div></div><img class="w-1/2 h-full rounded"${ssrRenderAttr("src", unref(homepage))}></section><section class="flex justify-center gap-5 my-20"><!--[-->`);
...
//# sourceMappingURL=index-wxxBKz4F.mjs.map
