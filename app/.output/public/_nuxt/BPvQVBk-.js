import{Q as y,aV as h,aW as a,aX as p,aY as c,ay as v,aZ as b,a_ as g,a$ as k,b0 as A}from"./DrJXerId.js";import{B as S}from"./B4rtYYsy.js";var E=`
    .p-ink {
        display: block;
        position: absolute;
...
`,w={root:"p-ink"},$=y.extend({name:"ripple-directive",style:E,classes:w}),T=S.extend({style:$});function o(e){"@babel/helpers - typeof";return o=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},o(e)}function _(e){return U(e)||R(e)||I(e)||x()}function x(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
