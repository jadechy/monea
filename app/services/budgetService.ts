...
export const fetchAllBudgetCategoriesByGroup = (
  group_id: GroupType["id"],
  month: Date
) =>
  fetchJson({
...
export const fetchAllRemainingBudgetCategoriesByGroup = (
  group_id: GroupType["id"],
  month: Date
) =>
  fetchJson({
...
export const BudgetRemainingByMonthSchema = z.record(
  z.string(),
...
export const fetchBudgetRemainingInYear = (
  group_id: GroupType["id"],
  year: string
) =>
  fetchJson({
...
export const fetchBudgetRemainingInMonth = (
  group_id: GroupType["id"],
  month: string
) =>
  fetchJson({
