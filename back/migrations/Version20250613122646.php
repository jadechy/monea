 ...
 */
final class Version20250613122646 extends AbstractMigration
{
    ...
    {
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_BUDGET (BGT_ID INT AUTO_INCREMENT NOT NULL, BGT_MONTH INT NOT NULL, BGT_AMOUNT DOUBLE PRECISION NOT NULL, USR_ID INT NOT NULL, GRP_ID INT NOT NULL, INDEX IDX_52A7F06FC4DC529D (USR_ID), INDEX IDX_52A7F06F1DAB1036 (GRP_ID), PRIMARY KEY(BGT_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_GROUPE (GRP_ID INT AUTO_INCREMENT NOT NULL, GRP_NAME VARCHAR(255) NOT NULL, GRP_CREATED_AT DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', GRP_TYPE VARCHAR(255) NOT NULL, GRP_IS_ACTIVE TINYINT(1) NOT NULL, USR_ID INT NOT NULL, INDEX IDX_25EC8B35C4DC529D (USR_ID), PRIMARY KEY(GRP_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_SHARE_EXPENSE (SHR_PERCENTAGE INT NOT NULL, USR_ID INT NOT NULL, EXP_ID INT NOT NULL, INDEX IDX_CF8CBBF3C4DC529D (USR_ID), INDEX IDX_CF8CBBF31AD3A99C (EXP_ID), PRIMARY KEY(SHR_PERCENTAGE)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_USER (USR_ID INT AUTO_INCREMENT NOT NULL, USR_USERNAME VARCHAR(50) NOT NULL, USR_NAME VARCHAR(50) NOT NULL, USR_LASTNAME VARCHAR(50) NOT NULL, USR_EMAIL VARCHAR(255) NOT NULL, USR_PASSWORD VARCHAR(255) NOT NULL, USR_ROLE JSON NOT NULL COMMENT '(DC2Type:json)', USR_CREATED_AT DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', UNIQUE INDEX UNIQ_70AADA227514CDD6 (USR_USERNAME), PRIMARY KEY(USR_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', available_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', delivered_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE MON_BUDGET ADD CONSTRAINT FK_52A7F06FC4DC529D FOREIGN KEY (USR_ID) REFERENCES MON_USER (USR_ID)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    {
        $this->addSql(<<<'SQL'
            ALTER TABLE MON_BUDGET DROP FOREIGN KEY FK_52A7F06FC4DC529D
        SQL);
        $this->addSql(<<<'SQL'
