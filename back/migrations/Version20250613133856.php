...
final class Version20250613133856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_SHARE_EXPENSE (SHR_PERCENTAGE INT NOT NULL, USR_ID INT NOT NULL, EXP_ID INT NOT NULL, INDEX IDX_CF8CBBF3C4DC529D (USR_ID), INDEX IDX_CF8CBBF31AD3A99C (EXP_ID), PRIMARY KEY(USR_ID, EXP_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
