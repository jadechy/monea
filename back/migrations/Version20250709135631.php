 ...
 */
final class Version20250709135631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_CATEGORY (CAT_ID INT AUTO_INCREMENT NOT NULL, CAT_LABEL VARCHAR(50) NOT NULL, CAT_COLOR VARCHAR(8) NOT NULL, GRP_ID INT NOT NULL, INDEX IDX_186C7E081DAB1036 (GRP_ID), PRIMARY KEY(CAT_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_EXPENSE (EXP_ID INT AUTO_INCREMENT NOT NULL, EXP_AMOUNT DOUBLE PRECISION NOT NULL, EXP_TITLE VARCHAR(150) NOT NULL, EXP_CREATED_AT DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', EXP_SPENT_AT DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', GRP_ID INT NOT NULL, CAT_ID INT NOT NULL, USR_ID INT NOT NULL, REC_ID INT DEFAULT NULL, INDEX IDX_CAF2C141DAB1036 (GRP_ID), INDEX IDX_CAF2C142E182825 (CAT_ID), INDEX IDX_CAF2C14C4DC529D (USR_ID), INDEX IDX_CAF2C14DEDC30FD (REC_ID), PRIMARY KEY(EXP_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_GROUPE (GRP_ID INT AUTO_INCREMENT NOT NULL, GRP_NAME VARCHAR(100) NOT NULL, GRP_CREATED_AT DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', GRP_TYPE VARCHAR(15) NOT NULL, GRP_PICTURE VARCHAR(255) DEFAULT NULL, GRP_COLOR VARCHAR(15) NOT NULL, PRIMARY KEY(GRP_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_GROUP_INVITATION (INV_ID INT AUTO_INCREMENT NOT NULL, INV_TOKEN VARCHAR(255) NOT NULL, INV_EMAIL VARCHAR(50) NOT NULL, INV_USED TINYINT(1) NOT NULL, INV_CREATED_AT DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', INV_ROLE VARCHAR(20) NOT NULL, GRP_ID INT NOT NULL, INDEX IDX_95FB11291DAB1036 (GRP_ID), PRIMARY KEY(INV_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_USER (USR_ID INT AUTO_INCREMENT NOT NULL, USR_USERNAME VARCHAR(50) NOT NULL, USR_NAME VARCHAR(50) NOT NULL, USR_LASTNAME VARCHAR(50) NOT NULL, USR_EMAIL VARCHAR(180) NOT NULL, USR_PASSWORD VARCHAR(128) NOT NULL, USR_ROLES JSON NOT NULL, USR_CREATED_AT DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', USR_PICTURE VARCHAR(255) DEFAULT NULL, USR_RESET_TOKEN VARCHAR(255) DEFAULT NULL, USR_BIRTHDAY DATE NOT NULL COMMENT '(DC2Type:date_immutable)', USR_GOOGLE_ID VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_70AADA227514CDD6 (USR_USERNAME), UNIQUE INDEX UNIQ_70AADA22D48A77F8 (USR_GOOGLE_ID), PRIMARY KEY(USR_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
