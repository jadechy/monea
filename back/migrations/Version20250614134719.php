...
final class Version20250614134719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_USER (USR_ID INT AUTO_INCREMENT NOT NULL, USR_USERNAME VARCHAR(50) NOT NULL, USR_NAME VARCHAR(50) NOT NULL, USR_LASTNAME VARCHAR(50) NOT NULL, USR_EMAIL VARCHAR(255) NOT NULL, USR_PASSWORD VARCHAR(255) NOT NULL, USR_ROLE JSON NOT NULL COMMENT '(DC2Type:json)', USR_CREATED_AT DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', USR_PICTURE VARCHAR(255), USR_RESET_TOKEN VARCHAR(255), UNIQUE INDEX UNIQ_70AADA227514CDD6 (USR_USERNAME), PRIMARY KEY(USR_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
