 ...
 */
final class Version20250619074732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_MEMBER (MBR_ROLE VARCHAR(255) NOT NULL, MBR_ADD_ON DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', MBR_STATUS VARCHAR(255) NOT NULL, GRP_ID INT NOT NULL, USR_ID INT NOT NULL, INDEX IDX_51B1FD6C1DAB1036 (GRP_ID), INDEX IDX_51B1FD6CC4DC529D (USR_ID), PRIMARY KEY(GRP_ID, USR_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE MON_USER (USR_ID INT AUTO_INCREMENT NOT NULL, USR_USERNAME VARCHAR(50) NOT NULL, USR_NAME VARCHAR(50) NOT NULL, USR_LASTNAME VARCHAR(50) NOT NULL, USR_EMAIL VARCHAR(255) NOT NULL, USR_PASSWORD VARCHAR(255) NOT NULL, USR_ROLES JSON NOT NULL, USR_CREATED_AT DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', USR_PICTURE VARCHAR(255) NOT NULL, USR_RESET_TOKEN VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_70AADA227514CDD6 (USR_USERNAME), PRIMARY KEY(USR_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
